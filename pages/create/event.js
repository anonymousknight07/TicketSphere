...
const event = () => {
  ...
  const [duration, setDuration] = useState("morning"); // New state for duration
  ...
  const handleSubmit = (e) => {
    ...
    createEvent(
      ...
      note,
      flier,
      duration, // Pass duration to createEvent
      router
    );
  };
  ...
  return (
    <div>
      <Head>
        <title>Create New Event | Ticket Sphere</title>
        <meta
          name='description'
          ...
          <div className='md:w-[80%] w-full min-h-[90vh] py-10 px-4'>
            ...
            <form className='flex flex-col' onSubmit={handleSubmit}>
              ...
              <div className='w-full flex justify-between mb-4'>
                ...
                <div className='w-1/3 flex flex-col ml-[20px]'>
                  <p>Date</p>
                  <DatePicker
                    selectsEnd
